...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setPreferredSize(new java.awt.Dimension(141, 42));

        jLabel8.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 102, 102));
        jLabel8.setText("CONNECT WITH PEOPLE");

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/registrationandlogin/pngtree-chat-logo-template-icon-design-png-image_5376209.png"))); // NOI18N
